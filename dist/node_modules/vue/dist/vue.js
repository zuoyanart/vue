define('node_modules/vue/dist/vue', function(require, exports, module) {
   ...
   */'use strict';(function(global,factory){typeof exports === 'object' && typeof module !== 'undefined'?module.exports = factory():typeof define === 'function' && define.amd?define(factory):global.Vue = factory();})(undefined,function(){'use strict'; /*  */ /**
  ...
  /* istanbul ignore if */if(typeof Promise !== 'undefined' && isNative(Promise)){var p=Promise.resolve();var logError=function logError(err){console.error(err);};timerFunc = function(){p.then(nextTickHandler)['catch'](logError); // in problematic UIWebViews, Promise.then doesn't completely break, but
   ...
   */function getType(fn){var match=fn && fn.toString().match(/^\s*function (\w+)/);return match && match[1];}function isType(type,fn){if(!Array.isArray(fn)){return getType(fn) === getType(type);}for(var i=0,len=fn.length;i < len;i++) {if(getType(fn[i]) === getType(type)){return true;}} /* istanbul ignore next */return false;}var util=Object.freeze(Object.defineProperties({defineReactive:defineReactive$$1,_toString:_toString,toNumber:toNumber,makeMap:makeMap,isBuiltInTag:isBuiltInTag,remove:remove$1,hasOwn:hasOwn,isPrimitive:isPrimitive,cached:cached,camelize:camelize,capitalize:capitalize,hyphenate:hyphenate,bind:bind$1,toArray:toArray,extend:extend,isObject:isObject,isPlainObject:isPlainObject,toObject:toObject,noop:noop,no:no,identity:identity,genStaticKeys:genStaticKeys,looseEqual:looseEqual,looseIndexOf:looseIndexOf,isReserved:isReserved,def:def,parsePath:parsePath,hasProto:hasProto,inBrowser:inBrowser,UA:UA,isIE:isIE,isIE9:isIE9,isEdge:isEdge,isAndroid:isAndroid,isIOS:isIOS,isServerRendering:isServerRendering,devtools:devtools,nextTick:nextTick,mergeOptions:mergeOptions,resolveAsset:resolveAsset,validateProp:validateProp},{_Set:{get:function get(){return _Set;},configurable:true,enumerable:true},warn:{get:function get(){return warn;},configurable:true,enumerable:true},formatComponentName:{get:function get(){return formatComponentName;},configurable:true,enumerable:true}})); /* not type checking this file because flow doesn't play well with Proxy */var initProxy;{var allowedGlobals=makeMap('Infinity,undefined,NaN,isFinite,isNaN,' + 'parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,' + 'Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,' + 'require' // for Webpack/Browserify
  ...
  function getRealChild(_x2){var _again2=true;_function2: while(_again2) {var vnode=_x2;_again2 = false;var compOptions=vnode && vnode.componentOptions;if(compOptions && compOptions.Ctor.options.abstract){_x2 = getFirstComponentChild(compOptions.children);_again2 = true;compOptions = undefined;continue _function2;}else {return vnode;}}}function extractTransitionData(comp){var data={};var options=comp.$options; // props
  ...
  //# sourceMappingURL=/node_modules/vue/dist/vue.js.map
